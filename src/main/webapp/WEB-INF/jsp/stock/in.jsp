...
<!-- 基础信息 -->
<div class="easyui-panel" title="入库信息" style="width:100%;height:26%;">
		...
		<tr>
 			...
 			<td><input id="stockType" value="${stockType }" type="text" style="display:none;"/>
 				<c:if test="${stockType==1 }">
 					<input class="easyui-textbox" type="text" id="typeName" data-options="required:true" value="新购入库" style="width:100%;" readonly="readonly"></input></td>
 				</c:if>
 				<c:if test="${stockType==2 }">
 					<input class="easyui-textbox" type="text" id="typeName" data-options="required:true" value="归还入库" style="width:100%;" readonly="readonly"></input></td>
 				</c:if>
 				<c:if test="${stockType==3 }">
 					<input class="easyui-textbox" type="text" id="typeName" data-options="required:true" value="退货入库" style="width:100%;" readonly="readonly"></input></td>
 				</c:if>
 			<td>入库日期:</td>
